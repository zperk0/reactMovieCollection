        ...
        navigationArr.map((menuItems, i) => {
            if (menuItems['navbarItem']) {
                if (menuItems.isActive === true) {
                    navigationJSX.push(<li role="presentation" className="active" key={i + "_navItem"} href='#'>
                                            <Link key={i} to={menuItems.href}>{menuItems.name}</Link>
                                        </li>);
                } else {
                    navigationJSX.push(<li role="presentation" key={i + "_navItem"} href='#'>
                                            <Link key={i} to={menuItems.href}>{menuItems.name}</Link>
                                        </li>);
                }
            }
                    ...
                    <Navbar.Header>
                        <Navbar.Brand>
                            <a target="_blank" className="navbar-brand">
                                <img className="navbar-logo" id={this.props.logoIDName} src={this.props.logoImgPath} alt="#"/>
                            </a>
                        </Navbar.Brand>
                        <Navbar.Toggle/>
                    </Navbar.Header>
